...
// PSEUDOCODE
// Generate a board => 64 squares

// a function that can square up exponents of 2, referencing
...
var grains = {
  ...
  calculateBoard: function(){
    ...
    _.each( this.board(), function ( index ) {
    output.push( grain.square( index ) );
      // debugger
    });
    return output;
  },
...
totalBoard: function(){
  var wheatBoard = this.calculatorBoard();
  return _.reduce( wheatBoard, function( num, sum ){
    return num + sum;
  }, 0 )
